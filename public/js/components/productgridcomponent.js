Vue.component('ProductGridComp', {
    ...
    <div class="container">
        ...
        <div class="item-flex">
            ...
            <div class="item">
                <a class="item-link" href="#"> 
                    <img class="item-pic" src="img/card-5.png" alt="product"></img>
                    <div class="txt-box">
                        <p class="item-desc">ELLERY X M'O CAPSULE</p>
                        <p class="item-price">$52.00</p>
                    </div>
            ...
            <div class="sec-button">
                <a href="product.html" class="button-sec">
                    <p class="button-text">Browse All Product</p>
                </a>
            </div>
